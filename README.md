...
uv run acp artifact add-article --product <product> --mdx article.mdx
...
```powershell
uv run acp media-cache import-workspace --project-root .
uv run acp media-cache status --project-root .
```
