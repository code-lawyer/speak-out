...
| Offline test suite | 88 tests passed on 2026-08-10, including concurrent publication attempts, exception-safe claim resolution, ambiguous VPS outcomes, exact-digest approval, legacy validation, Chrome lifecycle, and required social metadata readback; rerun after every release-gate change | verified |
