...
| Offline test suite | 82 tests passed on 2026-08-10, including concurrent publication claims, ambiguous VPS outcomes, legacy validation, Chrome lifecycle, and required social metadata; rerun after every release-gate change | verified |
